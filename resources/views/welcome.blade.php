...
<div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-center dark:bg-white selection:bg-red-500 selection:text-white">
    ...
    <div class="max-w-7xl mb-20 p-6 lg:p-8">
        ...
        <div class="justify-center">
            <form method="POST">
                ...
                <div class="relative">
                    ...
                    <button type="submit"
                            class="text-black font-semi-bold absolute end-2.5 bottom-2.5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-bold rounded-lg text-sm px-4 py-2 dark:bg-customGreen dark:hover:bg-highlightGreen dark:focus:ring-green-800">
                        Search
                    </button>
                </div>
            </form>
        ...
        <x-maps-leaflet :centerPoint="['lat' => $lat ?: 0, 'long' => $lng ?: 0]"
                        :markers="[['lat' => $lat ?: 0, 'long' => $lng ?: 0]]"></x-maps-leaflet>
